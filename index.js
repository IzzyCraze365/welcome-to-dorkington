...
const default_townTriangle = new Room({
  name: "Town Triangle",
...
const default_idiotsInspiringInn = new Room({
...
const default_upstairsRoom = new Room({
  name: "Upstairs Room",
...
const default_forlornForestOfFatality = new Room({
...
const default_deepWoodsOfCertainDoom = new Room({
...
const default_hagsHorridHovel = new Room({
...
const default_dragonsKeep = new Room({
  name: "Dragon's Keep",
...
const default_underworld = new Room({
  name: "Underworld",
...
const default_retiredAdventurer = new Person({
...
const default_simpleVillager = new Person({
...
const default_innkeeper = new Person({
  name: "Innkeeper",
...
const default_obnoxiousPatron = new Person({
...
const default_musicianWithABrokenArm = new Person({
...
const default_exhaustedParents = new Person({
...
const default_dragon = new Person({
  name: "Dragon",
  altNames: ["Dragon", "D"],
...
const default_grimReaper = new Person({
  name: "Grim Reaper",
...
const default_crookedSign = new Person({
  name: "Crooked Sign",
...
const default_letterbox = new Person({
  name: "Letterbox",
...
const default_moundsOfGold = new Person({
  name: "Mounds Of Gold",
...
const default_heapsOfSilver = new Person({
...
const default_pileOfBones = new Person({
  name: "Pile Of Bones",
...
const default_bucket = new Commodity({
  name: "Bucket",
  altNames: ["Bucket"],
...
const default_premiumHorseManure = new Commodity({
...
const default_warmMeal = new Commodity({
  name: "Warm Meal",
...
const default_BagOfJewels = new Commodity({
  name: "Bag Of Jewels",
  altNames: [
    "Bag Of Jewels",
    "Bags Of Jewels",
...
const default_warmApplePie = new Commodity({
  name: "Warm Apple Pie",
...
const default_damagedLute = new Commodity({
  name: "Damaged Lute",
...
const default_pointlessRock = new Commodity({
  name: "Pointless Rock",
...
const default_dragonsTreasure = new Commodity({
...
const default_deathsScythe = new Commodity({
  name: "Death's Scythe",
